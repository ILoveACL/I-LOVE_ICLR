...
model_name=enre_Qwen3-8B
step_num=1920
model_dir=/home/nian/ft_LLM/ft_model/TrainMethod_re_mohler/llm_EnRe/save_models/${model_name}/step_${step_num}/Qwen3-8B-finetune
result_name=/home/nian/ft_LLM/ft_model/TrainMethod_re_mohler/llm_EnRe/save_models/${model_name}/enre_8_mohler_${step_num}.json
